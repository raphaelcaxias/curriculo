...
def render_home():
    ...
    # Se não encontrou, usa um avatar gerado
        ...
        <div class="container">
            ...
            <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:1rem;">
                <div class="glass-card" style="text-align:center;">
                    <div style="font-size:2.4rem;font-weight:700;color:var(--primary);">16+</div>
                    <div style="color:var(--text-muted);">anos de experiência</div>
                </div>
                <div class="glass-card" style="text-align:center;">
                    <div style="font-size:2.4rem;font-weight:700;color:var(--primary);">70%</div>
                    <div style="color:var(--text-muted);">redução operacional</div>
                </div>
                <div class="glass-card" style="text-align:center;">
                    <div style="font-size:2.4rem;font-weight:700;color:var(--primary);">213k</div>
                    <div style="color:var(--text-muted);">registros processados</div>
                </div>
                <div class="glass-card" style="text-align:center;">
                    <div style="font-size:2.4rem;font-weight:700;color:var(--primary);">2h→15m</div>
                    <div style="color:var(--text-muted);">tempo de análise</div>
                </div>
                <div class="glass-card" style="text-align:center;">
                    <div style="font-size:2.4rem;font-weight:700;color:var(--primary);">R$50bi</div>
                    <div style="color:var(--text-muted);">dados analisados</div>
                </div>
            </div>
        </div>
    </div>
