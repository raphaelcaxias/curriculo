...
def inject_custom_css():
    ...
    <style>
        ...
        .about-quote strong { color: var(--ink); }        .about-differentials { padding: 0; list-style: none; }
        ...
        @media (max-width: 768px) {
            ...
            .tl-left { text-align: left; }            .contact-block { grid-template-columns: 1fr; }
...
# =============================================================================
# CARREGAMENTO DE ARQUIVOS — COM TIMEOUT E FALLBACK SEGURO
# =============================================================================
@st.cache_data(ttl=3600)
def load_image():
    """Carrega imagem do perfil com fallback local e tratamento de erros"""
    try:
...
@st.cache_data(ttl=3600)
def load_cv():
    """Carrega currículo PDF com fallback local e tratamento de erros"""
    try:
...
- [Contato](#contato)
    ...
    if cv_pdf:
        ...
        st.caption("PDF não localizado. Verifique o nome do arquivo.")
...
# ── SOBRE ─────────────────────────────────────────────────────────────────────
st.markdown('<a id="sobre"></a>', unsafe_allow_html=True)st.markdown("""
...
<div class="stack-grid">
    ...
    <div class="stack-block">
        ...
        <div class="stack-items">            <span class="stack-item">KPIs</span>
...
with st.expander("📊 Demonstração — Análise Interativa de Vendas vs Meta", expanded=False):
    ...
    fig.update_layout(
        ...
        height=320,
        margin=dict(t=50, b=20, l=0, r=0),        hovermode='x unified',
