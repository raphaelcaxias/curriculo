...
# ============================================================================
# FUNÇÕES DE RENDERIZAÇÃO (TUDO AQUI DENTRO)
# ============================================================================
...
def render_hero():
    ...
    with col2:
        ...
        if os.path.exists("Curriculo_Raphael_v2.pdf"):
            cv = "Curriculo_Raphael_v2.pdf"
        elif os.path.exists("assets/Curriculo_Raphael_v2.pdf"):
            cv = "assets/Curriculo_Raphael_v2.pdf"
