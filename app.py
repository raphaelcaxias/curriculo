...
def load_css():
    ...
    <style>
        ...
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        /* KPIs */
        .kpi-box {{
            background: {colors['card_bg']}; border: 1px solid {colors['border']}; border-radius: 12px;
...
if page == "🏠 Início":
    ...
    """, unsafe_allow_html=True)
    # Aqui você pode colocar um dashboard mais elaborado
    st.info("Em breve: Dashboard completo com indicadores de negócio.")
